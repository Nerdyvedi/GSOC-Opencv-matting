...
#define MKTYPE2_I(NAME) pygs##_##NAME##_specials(); if (!to_ok(&pygs##_##NAME##_Type)) return NULL;
#else
#define MKTYPE2(NAME) MKTYPE2_I(NAME)
#define MKTYPE2_I(NAME) pygs##_##NAME##_specials(); if (!to_ok(&pygs##_##NAME##_Type)) return
#endif
...
#include QUOTEME(build/pygs_generated_include.h)
...
#define PYOPENCV_TO  pygs_to
#define PYOPENCV_FROM  pygs_from
...
#include QUOTEME(build/pygs_generated_types.h)

#include QUOTEME(build/pygs_generated_funcs.h)
...
#include QUOTEME(build/pygs_generated_ns_reg.h)
...
#include QUOTEME(build/pygs_generated_type_reg.h)
...
#include QUOTEME(build/pygs_generated_type_publish.h)
